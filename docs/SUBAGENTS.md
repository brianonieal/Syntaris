...
Syntaris v0.6.0 ships 7 subagents in `.claude/agents/`. Three were inherited from v0.1.0; four were added in v0.3.0 to migrate the noisiest skills out of the main conversation context.

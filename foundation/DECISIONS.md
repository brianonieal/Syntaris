# DECISIONS.md
# Syntaris v0.4.0 | Architectural Decision Log
...
Owner: {{OWNER_NAME}}
Scope: This decision is specific to projects on the Syntaris v0.4.0 fintech stack. Non-fintech projects should evaluate embeddings providers against their own domain. Remove or replace this entry if your project is not fintech.
